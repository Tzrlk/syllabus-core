...
class EventDispatcher {
     ...
     */
    @Inject private EventHandlerCollection eventCollection;

    /**
     * Allows us to properly handle errors
     */
    @Inject private ErrorHandlerCollection errorHandlerCollection;

    /**
     * Event hook collection
     */
    @Inject private EventHookCollection eventHookCollection;

    /**
     * Contains the types for a specific type that needs to be marshalled
     */
    protected final Map<EventHandler<? extends EventRequestBase, ? extends EventResponseBase>, List<Class<?>>> marshallingTypes;
